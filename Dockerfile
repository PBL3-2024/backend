...
USER 1002
ENTRYPOINT ["java","-Djava.library.path=/application/dependencies/BOOT-INF/lib:/usr/java/packages/lib:/usr/lib64:/lib64:/lib:/usr/lib","org.springframework.boot.loader.launch.JarLauncher"]